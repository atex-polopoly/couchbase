...
default['couchbase']['vault'] = 'couchbase-users'
default['couchbase']['data_path'] = '/mnt/data/couchbase/data'
default['couchbase']['index_path'] = '/mnt/data/couchbase/index'
default['couchbase']['host_name'] = '127.0.0.1'
default['couchbase']['user'] = 'couchbase'
default['couchbase']['group'] = 'couchbase'
default['couchbase']['cluster_ram_size'] = '500' #min 256
default['couchbase']['fts_ram_size'] = '256' #min 256
default['couchbase']['index_ram_size'] = '256' #min 256
default['couchbase']['bucket_ram_size'] = '300' #min 256
